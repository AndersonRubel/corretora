<div class="app-wrapper" id="baixas">
    <div class="app-content pt-3 p-md-3 p-lg-4">
        ...
        <div class="row g-3 align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <h1 class="app-page-title mb-0">Estoque - Ver Baixas</h1>
            </div>
        ...
        <div class="card mb-4">
            <div class="card-header fw-bold">Baixas de Estoque</div>
            <div class="app-card shadow-sm">
                <div class="app-card-body">
                    <div class="app-card app-card-orders-table shadow-sm">
                        <div class="app-card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-striped mb-0 text-left" id="tableVerBaixas"></table>
                            </div>
                        </div>
                    </div>
                </div>
