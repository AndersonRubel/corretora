                        ...
                        <div class="app-card-body">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-lg-2 col-sm-12 mb-2">
                                    ...
                                    <input type="datetime-local" class="form-control" name="data_inicio" required value="<?= old('data_inicio', date('Y-m-d\TH:i', strtotime($reserva['data_inicio']))); ?>" data-tippy-content="Data de Início da Reserva">
                                </div>
                                <div class="col-md-2 col-lg-2 col-sm-12 mb-2">
                                    <label class="form-label">Data Fim</label>
                                    <input type="datetime-local" class="form-control" name="data_fim" required value="<?= old('data_fim', date('Y-m-d\TH:i', strtotime($reserva['data_fim']))); ?>" data-tippy-content="Data do Fim da Reserva">
                                </div>
