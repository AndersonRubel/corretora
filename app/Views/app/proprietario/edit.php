    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="row g-3 align-items-center justify-content-between">
                ...
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">Alterar Proprietário<i class="fa fa-question-circle" id="btnHelp"></i></h1>
                </div>
                        ...
                        <div class="app-card-body">
                            <div class="row">
                                ...
                                <div class="col-md-5 col-lg-5 col-sm-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="rua" value="<?= old('rua', $proprietario['endereco']['rua']); ?>">
                                </div>
                                <div class="col-md-2 col-lg-2 col-sm-12 mb-2">
                                ...
                                <div class="col-md-3 col-lg-3 col-sm-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="bairro" value="<?= old('bairro', $proprietario['endereco']['bairro']); ?>">
                                </div>
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="cidade_completa" value="<?= old('cidade', $proprietario['endereco']['cidade']); ?>/<?= old('uf', $proprietario['endereco']['uf']); ?>">
                                </div>
