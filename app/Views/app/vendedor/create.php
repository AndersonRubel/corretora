    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="row g-3 align-items-center justify-content-between">
                ...
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">Adicionar Vendedor</h1>
                </div>
            ...
            <!-- Inicio :: Formulário -->
            <form method="POST" action="<?= base_url('vendedor/store'); ?>">
                        ...
                        <div class="app-card-body">
                            <div class="row mb-2">
                                <div class="col-md-3 col-lg-3 col-sm-12">
                                    <label class="form-label">Tipo de Pessoa <?php $value = old('tipo_pessoa'); ?></label>
                                    <select class="form-control" name="tipo_pessoa" id="tipoPessoa" required>
                                        <option value="1" <?= old('tipo_pessoa') == 1 ? 'selected' : '' ?>>Pessoa Física <?= $value ?></option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-lg-3 col-sm-12 mb-2">
                                    ...
                                    <input type="date" class="form-control" name="data_inicio_venda" value="<?= old('data_inicio_venda'); ?>">
                                </div>
                                <div class="col-md-3 col-lg-3 col-sm-12 mb-2">
                                ...
                                <div class="col-md-2 col-lg-2 col-sm-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="cep" data-mask="cep" value="<?= old('cep'); ?>">
                                </div>
                                <div class="col-md-5 col-lg-5 col-sm-12 mb-2">
                                    <label class="form-label">Rua</label>
                                    <input type="text" class="form-control" name="rua" readonly value="<?= old('rua'); ?>">
                                </div>
                                <div class="col-md-2 col-lg-2 col-sm-12 mb-2">
                                    <label class="form-label">Número</label>
                                    <input type="text" class="form-control" name="numero" data-verificaNumero="true" value="<?= old('numero'); ?>">
                                </div>
                                <div class="col-md-3 col-lg-3 col-sm-12 mb-2">
                                    <label class="form-label">Bairro</label>
                                    <input type="text" class="form-control" name="bairro" readonly value="<?= old('bairro'); ?>">
                                </div>
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-12 mb-2">
                                    ...
                                    <input type="hidden" name="uf" value="<?= old('uf'); ?>">
                                    <input type="text" class="form-control" name="cidade_completa" readonly value="<?= old('cidade'); ?>/<?= old('uf'); ?>">
                                </div>
                            </div>
                        ...
                        <div class="app-card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-12 mb-2">
                                    ...
                                    <input type="password" class="form-control" name="senha" autocomplete="off" required>
                                </div>
                                <div class="col-md-4 col-lg-4 col-sm-12 mb-2">
                                    <label class="form-label">Confirmar Senha</label>
                                    <input type="password" class="form-control" name="confirmar_senha" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
                    </div>
