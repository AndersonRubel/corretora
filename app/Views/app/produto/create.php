    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="row g-3 align-items-center justify-content-between">
                ...
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">Adicionar Produto</h1>
                </div>
            ...
            <!-- Inicio :: Formulário -->
            <form method="POST" action="<?= base_url('produto/store'); ?> " enctype=" multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-lg-3 col-sm-12 mb-2">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        <input type="text" class="form-control" name="codigo_barras" data-verificanumero="true" required value="<?= old('codigo_barras'); ?>">
                                ...
                                <div class="col-md-3 col-lg-3 col-sm-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="referencia_fornecedor" value="<?= old('referencia_fornecedor'); ?>">
                                </div>
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="categorias" data-select="buscarCategoria" required value="<?= old('categorias'); ?>">
                                </div>
                                <div class="col-md-3 col-lg-3 col-sm-12 mb-2">
                                    <label class="form-label">Fornecedor</label>
                                    <input type="text" class="form-control" name="codigo_fornecedor" data-select="buscarFornecedor" required value="<?= old('codigo_fornecedor'); ?>">
                                </div>
                                <div class="col-md-3 col-lg-3 col-sm-12 mb-2">
                                ...
                                <div class="col-md-3 col-lg-3 col-sm-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="ncm" value="<?= old('ncm'); ?>">
                                </div>
                                <div class="col-md-3 col-lg-3 col-sm-12 mb-2">
                                    <label class="form-label">CEST</label>
                                    <input type="text" class="form-control" name="cest" value="<?= old('cest'); ?>">
                                </div>
                                <div class="col-md-12 col-lg-12 col-sm-12 mb-4">
                                    <label class="form-label">Descrição</label>
                                    <textarea class="form-control" name="descricao" rows="2"><?= old('descricao'); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
