                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-lg-3 col-sm-12 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="codigo_categoria_imovel"
                                                ...
                                                value="<?= old('codigo_categoria_imovel'); ?>">
                                        </div>
                                        <div class="col-md-3 col-lg-3 col-sm-12 mb-2">
                                        ...
                                        <div class="col-md-3 col-lg-3 col-sm-12 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="valor" data-mask="dinheiro"
                                                required value="<?= old('valor'); ?>" placeholder="0,00">
                                        </div>
                                        <div class="col-md-6 col-lg-6 col-sm-12 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="codigo_proprietario"
                                                ...
                                                value="<?= old('codigo_proprietario'); ?>">
                                        </div>
                                        <div class="col-md-12 col-lg-12 col-sm-12 mb-4">
                                            <label class="form-label">Descrição</label>
                                            <textarea class="form-control" name="descricao" rows="2"
                                                data-tippy-content="Informe uma Descrição Para o Imóvel"><?= old('descricao'); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
