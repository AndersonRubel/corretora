    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="row g-3 align-items-center justify-content-between">
                ...
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">Alterar Tipo Imóvel</h1>
                </div>
            ...
            <!-- Inicio :: Formulário -->
            <form method="POST" action="<?= base_url("tipoImovel/update/{$tipoImovel['uuid_tipo_imovel']}"); ?>">
                        ...
                        <div class="app-card-body">
                            <div class="row">
                                <div class="col-md-4 col-lg-4 col-sm-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="nome" required value="<?= old('nome', $tipoImovel['nome']); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
