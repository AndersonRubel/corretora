            ...
            <div class="col-lg-8">
                <div>
                    <div class="slide-one-item home-slider owl-carousel">
                        ...
                        <div>
                            <img src="<?= $value['diretorio_imagem'] ?>" alt="Image"
                                style="object-fit:cover; width:100%;height:400px !important">
                        </div>
                        <?php endforeach; ?>
                    </div>
                </div>
                <div class="bg-white property-body border-bottom border-left border-right">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                            ...
                            <strong class="d-block"><?= $imovel['estacionamento'] ?></strong>
                        </div>
                    </div>
                    ...
                    <div class="row no-gutters mt-5">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <a href="<?= $value['diretorio_imagem'] ?>" class="image-popup gal-item"><img
                                    src="<?= $value['diretorio_imagem'] ?>" alt="Image" class="img-fluid"></a>
                        </div>
                        <?php endforeach; ?>
                    </div>
                </div>
