    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            ...
            <div class="row g-3 align-items-center justify-content-between">
                ...
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">Alterar Usuário<i class="fa fa-question-circle" id="btnHelp"></i></h1>
                </div>
            ...
            <!-- Inicio :: Formulário -->
            <form method="POST" action="<?= base_url("usuario/update/{$usuario['uuid_usuario']}"); ?>">
                        ...
                        <div class="app-card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="codigo_cadastro_grupo" data-select="buscarGrupo" value="<?= old('codigo_cadastro_grupo', $usuario['grupo_acesso']); ?>">
                                </div>
                                <div class="col-md-4 col-lg-4 col-sm-12 mb-2">
                                    <label class="form-label">Empresa Padrão</label>
                                    <input type="text" class="form-control" name="codigo_empresa" data-select="buscarEmpresa" readonly value="<?= old('codigo_empresa', $usuario['empresa_padrao']); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
