...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url('assets/img/favicon/apple-touch-icon-57x57.png'); ?>"
        sizes="196x196">
    <link rel="icon" type="image/png" href="<?= base_url('assets/img/favicon/apple-touch-icon-57x57.png'); ?>"
        sizes="96x96">
    <link rel="icon" type="image/png" href="<?= base_url('assets/img/favicon/apple-touch-icon-57x57.png'); ?>"
    ...
    <!-- JQUERY -->
    <script type="text/javascript" src="https://code.jquery.com/jquery-3.6.0.min.js?versao=<?= $base->version; ?>">
    </script>
    <script type="text/javascript"
        src="https://cdnjs.cloudflare.com/ajax/libs/jquery.mask/1.14.16/jquery.mask.min.js?versao=<?= $base->version; ?>">
    </script>
    <script type="text/javascript"
        src="https://cdnjs.cloudflare.com/ajax/libs/jquery-maskmoney/3.0.2/jquery.maskMoney.min.js?versao=<?= $base->version; ?>">
    </script>

    <!-- BOOTSTRAP -->
    <script type="text/javascript"
        src="https://unpkg.com/@popperjs/core@2/dist/umd/popper.min.js?versao=<?= $base->version; ?>"></script>
    <!-- <script type="text/javascript" src="https://unpkg.com/tippy.js@6/dist/tippy-bundle.umd.js?versao=<?= $base->version; ?>"></script> -->
    <script type="text/javascript"
        src="https://cdnjs.cloudflare.com/ajax/libs/tippy.js/6.3.1/tippy-bundle.umd.js?versao=<?= $base->version; ?>">
    </script>

    <link rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/fontawesome.min.css?versao=<?= $base->version; ?>">
    <link rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css?versao=<?= $base->version; ?>">

    <!-- SWEETALERT 2 -->
    <script
        src="https://cdn.jsdelivr.net/npm/sweetalert2@11.0.19/dist/sweetalert2.all.min.js?versao=<?= $base->version; ?>">
    </script>

    <!-- MOMENT -->
    <script type="text/javascript"
        src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment.min.js?versao=<?= $base->version; ?>">
    </script>
    <script type="text/javascript"
        src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment-with-locales.min.js?versao=<?= $base->version; ?>">
    </script>

    <!-- SELECT 2-->
    <link rel="stylesheet" href="<?= base_url("assets/plugins/select2/select2.css"); ?>?versao=<?= $base->version; ?>">
    <link rel="stylesheet"
        href="<?= base_url("assets/plugins/select2/select2-bootstrap.css"); ?>?versao=<?= $base->version; ?>">
    <script type="text/javascript"
        src="<?= base_url("assets/plugins/select2/select2.js"); ?>?versao=<?= $base->version; ?>"></script>
    <script type="text/javascript"
        src="<?= base_url("assets/plugins/select2/select2_locale_pt-BR.js"); ?>?versao=<?= $base->version; ?>"></script>
    ...
    <!-- Tinymce -->
    <script type="text/javascript"
        src="https://cdnjs.cloudflare.com/ajax/libs/tinymce/5.8.2/tinymce.min.js?versao=<?= $base->version; ?>">
    </script>

    <!-- Funções Padrão -->
    <script type="text/javascript" src="<?= base_url("assets/js/ajax-control.js"); ?>?versao=<?= $base->version; ?>">
    </script>
    <script type="text/javascript" src="<?= base_url("assets/js/app.js"); ?>?versao=<?= $base->version; ?>"></script>
    <script type="text/javascript" src="<?= base_url("assets/js/convert.js"); ?>?versao=<?= $base->version; ?>">
    </script>
    <script type="text/javascript" src="<?= base_url("assets/js/mask.js"); ?>?versao=<?= $base->version; ?>"></script>
    <script type="text/javascript" src="<?= base_url("assets/js/notification.js"); ?>?versao=<?= $base->version; ?>">
    </script>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdn.datatables.net/autofill/2.3.7/css/autoFill.dataTables.css" />
    <link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdn.datatables.net/keytable/2.6.2/css/keyTable.dataTables.min.css" />
    <link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdn.datatables.net/scroller/2.0.4/css/scroller.dataTables.min.css" />
    <link rel="stylesheet" type="text/css"
    ...
    <script type="text/javascript" src="https://cdn.datatables.net/autofill/2.3.7/js/dataTables.autoFill.min.js">
    </script>
    <script type="text/javascript" src="https://cdn.datatables.net/autofill/2.3.7/js/autoFill.dataTables.min.js">
    </script>
    ...
    <script type="text/javascript" src="https://cdn.datatables.net/keytable/2.6.2/js/dataTables.keyTable.min.js">
    </script>

    <script type="text/javascript" src="https://cdn.datatables.net/responsive/2.2.9/js/dataTables.responsive.min.js">
    </script>
    <script type="text/javascript" src="https://cdn.datatables.net/responsive/2.2.9/js/responsive.dataTables.min.js">
    </script>
    <script type="text/javascript" src="https://cdn.datatables.net/rowgroup/1.1.3/js/dataTables.rowGroup.min.js">
    </script>
    <script type="text/javascript" src="https://cdn.datatables.net/rowreorder/1.2.8/js/dataTables.rowReorder.min.js">
    </script>
    <script type="text/javascript" src="https://cdn.datatables.net/scroller/2.0.4/js/dataTables.scroller.min.js">
    </script>
    <script type="text/javascript"
        src="https://cdn.datatables.net/searchbuilder/1.1.0/js/dataTables.searchBuilder.min.js"></script>
    <script type="text/javascript"
        src="https://cdn.datatables.net/searchbuilder/1.1.0/js/searchBuilder.dataTables.min.js"></script>
    <script type="text/javascript" src="https://cdn.datatables.net/searchpanes/1.3.0/js/dataTables.searchPanes.min.js">
    </script>
    <script type="text/javascript" src="https://cdn.datatables.net/searchpanes/1.3.0/js/searchPanes.dataTables.min.js">
    </script>
...
<body class="app">
    ...
    <body class="app app-login p-0">
        ...
        <div class="loader">
            <div class="wrapper">
                <img src="<?= base_url("assets/img/icone-casa.png"); ?>" alt="Loader">
                <p>Carregando...</p>
            </div>
        </div>
        <!-- Fim :: Loader -->
