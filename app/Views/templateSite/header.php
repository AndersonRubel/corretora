...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url("assets/site/fonts/icomoon/style.css") ?>">
    ...
    <link rel="stylesheet" href="<?= base_url("assets/site/css/mediaelementplayer.css") ?>">
    <link rel="stylesheet" href="<?= base_url("assets/site/css/animate.css") ?>">
    <link rel="stylesheet" href="<?= base_url("assets/site/fonts/flaticon/font/flaticon.css") ?>">
    <link rel="stylesheet" href="<?= base_url("assets/site/css/fl-bigmug-line.css") ?>">
