...
class CreateTableEmpresaComissao extends Migration
{
    ...
    public function up()
    {
        $this->forge->addField([
            ...
            'percentual'          => ['type' => 'VARCHAR', 'null' => true],
            'valor_inicial'       => ['type' => 'BIGINT', 'null' => true],
            'valor_final'         => ['type' => 'BIGINT', 'null' => true],
        ]);
