...
class EstoqueBaixaModel extends BaseModel
{
    ...
    public function getDataGrid(array $dadosDataGrid, string $condicoes = "1=1")
    {
        ...
        $this->select("
            {$this->table}.uuid_estoque_baixa
          , {$this->table}.codigo_estoque_baixa
        ...
        $this->join('estoque', 'estoque.codigo_estoque = estoque_baixa.codigo_estoque');
        $this->join('produto', 'produto.codigo_produto = estoque_baixa.codigo_produto');
